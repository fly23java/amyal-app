...
<div class="mb-3 row">
    ...
    <div class="col-lg-10 col-xl-9">
        <input class="form-control{{ $errors->has('driver_name_arabic') ? ' is-invalid' : '' }}" name="driver_name_arabic" type="text" id="driver_name_arabic" value="{{ old('driver_name_arabic', isset(optional($vehicle)->driver->name_arabic)) }}" maxlength="255" placeholder="{{ trans('drivers.name_arabic__placeholder') }}">
...
<div class="mb-3 row">
    ...
    <div class="col-lg-10 col-xl-9">
        <input class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" type="text" id="phone" value="{{ old('phone', isset(optional($vehicle)->driver->phone)) }}" maxlength="255" placeholder="{{ trans('drivers.phone__placeholder') }}">
...
<div class="mb-3 row">
    ...
    <div class="col-lg-10 col-xl-9">
        <input class="form-control{{ $errors->has('identity_number') ? ' is-invalid' : '' }}" name="identity_number" type="text" id="identity_number" value="{{ old('identity_number', isset(optional($vehicle)->driver->identity_number)) }}" min="0" max="255" placeholder="{{ trans('drivers.identity_number__placeholder') }}">
