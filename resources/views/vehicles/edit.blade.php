...
@section('content')
    ...
    <div class="card text-bg-theme">
        ...
        <div class="card-body">
            ...
            <form method="POST" class="needs-validation" novalidate action="{{ route('vehicles.vehicle.update', $vehicle->id) }}" id="edit_vehicle_form" name="edit_vehicle_form" accept-charset="UTF-8" >
            {{ csrf_field() }}
            ...
            @include ('vehicles.form', [
                ...
                <div class="col-lg-10 col-xl-9 offset-lg-2 offset-xl-3">
                    <input class="btn btn-primary" type="submit" value="{{ trans('vehicles.update') }}">
                </div>
            </form>
