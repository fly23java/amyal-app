...
@section('content')
    ...
    <div class="card text-bg-theme">
         ...
         <div class="card-header d-flex justify-content-between align-items-center p-3">
            <h4 class="m-0">{{ trans('regions.create') }}</h4>
            <div>
        ...
        <div class="card-body">
            ...
            <form method="POST" class="needs-validation" novalidate action="{{ route('regions.region.store') }}" accept-charset="UTF-8" id="create_region_form" name="create_region_form" >
            {{ csrf_field() }}
