...
@section('content')
    ...
    <div class="card text-bg-theme">
         ...
         <div class="card-header d-flex justify-content-between align-items-center p-3">
            <h4 class="m-0">{{ !empty($user->name) ? $user->name : 'User' }}</h4>
            <div>
        ...
        <div class="card-body">
            ...
            <form method="POST" class="needs-validation" novalidate action="{{ route('users.user.update', $user->id) }}" id="edit_user_form" name="edit_user_form" accept-charset="UTF-8" >
            {{ csrf_field() }}
