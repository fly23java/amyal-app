            ...
            <form action="{{ route('vehicle-types.store') }}" method="POST">
                ...
                <input type="hidden" name="id" id="id">
                        <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="name_arabic" name="name_arabic" placeholder="{{ __('vehicle-types.name_arabic') }}" value="{{ old('name_arabic') }}" maxlength="50" >
                                    @error('name_arabic')
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="name_english" name="name_english" placeholder="{{ __('vehicle-types.name_english') }}" value="{{ old('name_english') }}" maxlength="50" >
                                    @error('name_english')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
