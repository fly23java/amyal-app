...
@section('content')
    ...
    <div class="card text-bg-theme">
         ...
         <div class="card-header d-flex justify-content-between align-items-center p-3">
            <h4 class="m-0">{{ trans('drivers.create') }}</h4>
            <div>
        ...
        <div class="card-body">
            ...
            <form method="POST" class="needs-validation" novalidate action="{{ route('drivers.driver.store') }}" accept-charset="UTF-8" id="create_driver_form" name="create_driver_form" >
            {{ csrf_field() }}
