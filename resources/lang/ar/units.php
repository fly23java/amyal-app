...
return [
    ...
    'index_route_description' => 'Retrieve existing units.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the unit property name where the value is the assigned value to the retrieved unit.',
    ...
    'show_route_description' => 'Retrieve existing unit.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the unit to retrieve',
    'destroy_route_description' => 'Delete existing unit.',
    ...
    'the_id_of_model_to_delete' => 'The id of the unit to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete units.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the unit.',
    ...
    'the_requested_model_does_not_exists' => 'The requested unit does not exists.',
    ...
    'edit' => 'Edit Unit',
    'show' => 'Show Unit',
    'show_all' => 'Show All Unit',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Unit.',
    'none_available' => 'No Units Available.',
    'model_plural' => 'Units',
    'model_was_added' => 'Unit was successfully added.',
    'model_was_retrieved' => 'Unit was successfully retrieved.',
    'models_were_retrieved' => 'Units were successfully retrieved.',
    'model_was_updated' => 'Unit was successfully updated.',
    'model_was_deleted' => 'Unit was successfully deleted.',
