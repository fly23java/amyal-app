...
return [
    ...
    'index_route_description' => 'Retrieve existing goods types.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the goods type property name where the value is the assigned value to the retrieved goods type.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved goods type.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of goods types per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved goods type.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new goods type.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existing goods type.',
    ...
    'show_route_description' => 'Retrieve existing goods type.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the goods type to retrieve',
    'destroy_route_description' => 'Delete existing goods type.',
    ...
    'the_id_of_model_to_delete' => 'The id of the goods type to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete goods types.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the goods type.',
    ...
    'the_requested_model_does_not_exists' => 'The requested goods type does not exists.',
    ...
    'create' => 'Create New Goods Type',
    'delete' => 'Delete Goods Type',
    'edit' => 'Edit Goods Type',
    'show' => 'Show Goods Type',
    'show_all' => 'Show All Goods Type',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Goods Type.',
    'none_available' => 'No Goods Types Available.',
    'model_plural' => 'Goods Types',
    'model_was_added' => 'Goods Type was successfully added.',
    'model_was_retrieved' => 'Goods Type was successfully retrieved.',
    'models_were_retrieved' => 'Goods Types were successfully retrieved.',
    'model_was_updated' => 'Goods Type was successfully updated.',
    'model_was_deleted' => 'Goods Type was successfully deleted.',
    ...
    'model_id_camel_case' => 'goods typeId',
