...
return [
    ...
    'serial_number__placeholder' => 'Enter serial number here...',
    'user_id' => 'User',
    'user_id__placeholder' => 'Select user',
    'loading_city_id' => 'Loading City',
    'loading_city_id__placeholder' => 'Select loading city',
    'loading_location' => 'Loading Location',
    'loading_location__placeholder' => 'Enter loading location here...',
    'unloading_city_id' => 'Unloading City',
    'unloading_city_id__placeholder' => 'Select unloading city',
    'unloading_location' => 'Unloading Location',
    'unloading_location__placeholder' => 'Enter unloading location here...',
    'vehicle_type_id' => 'Vehicle Type',
    'vehicle_type_id__placeholder' => 'Select vehicle type',
    'goods_id' => 'Goods',
    'goods_id__placeholder' => 'Select goods',
    'status_id' => 'Status',
    'status_id__placeholder' => 'Select status',
    'price' => 'Price',
    'price__placeholder' => 'Enter price here...',
    'carrier_price' => 'Carrier Price',
    'carrier_price__placeholder' => 'Enter carrier price here...',
    'supervisor_user_id' => 'Supervisor User',
    'supervisor_user_id__placeholder' => 'Select supervisor user',
    ...
    'index_route_description' => 'Retrieve existing shipments.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the shipment property name where the value is the assigned value to the retrieved shipment.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved shipment.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of shipments per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved shipment.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new shipment.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existing shipment.',
    ...
    'show_route_description' => 'Retrieve existing shipment.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the shipment to retrieve',
    'destroy_route_description' => 'Delete existing shipment.',
    ...
    'the_id_of_model_to_delete' => 'The id of the shipment to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete shipments.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the shipment.',
    ...
    'the_requested_model_does_not_exists' => 'The requested shipment does not exists.',
    ...
    'edit' => 'Edit Shipment',
    'show' => 'Show Shipment',
    'show_all' => 'Show All Shipment',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Shipment.',
    'none_available' => 'No Shipments Available.',
    'model_plural' => 'Shipments',
    'model_was_added' => 'Shipment was successfully added.',
    'model_was_retrieved' => 'Shipment was successfully retrieved.',
    'models_were_retrieved' => 'Shipments were successfully retrieved.',
    'model_was_updated' => 'Shipment was successfully updated.',
    'model_was_deleted' => 'Shipment was successfully deleted.',
    ...
    'model_id_camel_case' => 'shipmentId',
