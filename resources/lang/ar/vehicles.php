...
return [
    ...
    'owner_name__placeholder' => 'Enter owner name here...',
    'sequence_number' => 'Sequence Number',
    'sequence_number__placeholder' => 'Enter sequence number here...',
    'plate' => 'Plate',
    'plate__placeholder' => 'Enter plate here...',
    'right_letter' => 'Right Letter',
    'right_letter__placeholder' => 'Enter right letter here...',
    'middle_letter' => 'Middle Letter',
    'middle_letter__placeholder' => 'Enter middle letter here...',
    'left_letter' => 'Left Letter',
    'left_letter__placeholder' => 'Enter left letter here...',
    'plate_type' => 'Plate Type',
    'plate_type__placeholder' => 'Enter plate type here...',
    ...
    'index_route_description' => 'Retrieve existing vehicles.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the vehicle property name where the value is the assigned value to the retrieved vehicle.',
    ...
    'show_route_description' => 'Retrieve existing vehicle.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the vehicle to retrieve',
    'destroy_route_description' => 'Delete existing vehicle.',
    ...
    'the_id_of_model_to_delete' => 'The id of the vehicle to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete vehicles.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the vehicle.',
    ...
    'the_requested_model_does_not_exists' => 'The requested vehicle does not exists.',
