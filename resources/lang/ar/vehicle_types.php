...
return [
    ...
    'index_route_description' => 'Retrieve existing vehicle types.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the vehicle type property name where the value is the assigned value to the retrieved vehicle type.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved vehicle type.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of vehicle types per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved vehicle type.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new vehicle type.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existing vehicle type.',
    ...
    'show_route_description' => 'Retrieve existing vehicle type.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the vehicle type to retrieve',
    'destroy_route_description' => 'Delete existing vehicle type.',
    ...
    'the_id_of_model_to_delete' => 'The id of the vehicle type to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete vehicle types.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the vehicle type.',
    ...
    'the_requested_model_does_not_exists' => 'The requested vehicle type does not exists.',
    ...
    'create' => 'Create New Vehicle Type',
    'delete' => 'Delete Vehicle Type',
    'edit' => 'Edit Vehicle Type',
    'show' => 'Show Vehicle Type',
    'show_all' => 'Show All Vehicle Type',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Vehicle Type.',
    'none_available' => 'No Vehicle Types Available.',
    'model_plural' => 'Vehicle Types',
    'model_was_added' => 'Vehicle Type was successfully added.',
    'model_was_retrieved' => 'Vehicle Type was successfully retrieved.',
    'models_were_retrieved' => 'Vehicle Types were successfully retrieved.',
    'model_was_updated' => 'Vehicle Type was successfully updated.',
    'model_was_deleted' => 'Vehicle Type was successfully deleted.',
    ...
    'model_id_camel_case' => 'vehicle typeId',
