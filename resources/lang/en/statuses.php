...
return [
    ...
    'message_text_in_arabic' => 'Message Text In Arabic',
    'message_text_in_arabic__placeholder' => 'Enter message text in arabic here...',
    'message_text_in_english' => 'Message Text In English',
    'message_text_in_english__placeholder' => 'Enter message text in english here...',
    'confirm_sending_the_message' => 'Confirm Sending The Message',
    'confirm_sending_the_message__placeholder' => 'Enter confirm sending the message here...',
    'parent_id' => 'Parent',
    'parent_id__placeholder' => 'Select parent',
    ...
    'index_route_description' => 'Retrieve existing statuses.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the status property name where the value is the assigned value to the retrieved status.',
    ...
    'show_route_description' => 'Retrieve existing status.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the status to retrieve',
    'destroy_route_description' => 'Delete existing status.',
    ...
    'the_id_of_model_to_delete' => 'The id of the status to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete statuses.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the status.',
    ...
    'the_requested_model_does_not_exists' => 'The requested status does not exists.',
    ...
    'edit' => 'Edit Status',
    'show' => 'Show Status',
    'show_all' => 'Show All Status',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Status.',
    'none_available' => 'No Statuses Available.',
    'model_plural' => 'Statuses',
    'model_was_added' => 'Status was successfully added.',
    'model_was_retrieved' => 'Status was successfully retrieved.',
    'models_were_retrieved' => 'Statuses were successfully retrieved.',
    'model_was_updated' => 'Status was successfully updated.',
    'model_was_deleted' => 'Status was successfully deleted.',
