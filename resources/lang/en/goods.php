...
return [
    ...
    'goods_type_id__placeholder' => 'Select goods type',
    'unit_id' => 'Unit',
    'unit_id__placeholder' => 'Select unit',
    'account_id' => 'Account',
    'account_id__placeholder' => 'Enter account here...',
    ...
    'index_route_description' => 'Retrieve existing goods.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the goods property name where the value is the assigned value to the retrieved goods.',
    ...
    'show_route_description' => 'Retrieve existing goods.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the goods to retrieve',
    'destroy_route_description' => 'Delete existing goods.',
    ...
    'the_id_of_model_to_delete' => 'The id of the goods to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete goods.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the goods.',
    ...
    'the_requested_model_does_not_exists' => 'The requested goods does not exists.',
    ...
    'create' => 'Create New Goods',
    'delete' => 'Delete Goods',
    'edit' => 'Edit Goods',
    'show' => 'Show Goods',
    'show_all' => 'Show All Goods',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Goods.',
    'none_available' => 'No Goods Available.',
    'model_plural' => 'Goods',
    'model_was_added' => 'Goods was successfully added.',
    'model_was_retrieved' => 'Goods was successfully retrieved.',
    'models_were_retrieved' => 'Goods were successfully retrieved.',
    'model_was_updated' => 'Goods was successfully updated.',
    'model_was_deleted' => 'Goods was successfully deleted.',
