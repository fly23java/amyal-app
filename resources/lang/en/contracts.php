...
return [
    ...
    'index_route_description' => 'Retrieve existing contracts.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the contract property name where the value is the assigned value to the retrieved contract.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved contract.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of contracts per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved contract.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new contract.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existing contract.',
    ...
    'show_route_description' => 'Retrieve existing contract.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the contract to retrieve',
    'destroy_route_description' => 'Delete existing contract.',
    ...
    'the_id_of_model_to_delete' => 'The id of the contract to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete contracts.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the contract.',
    ...
    'the_requested_model_does_not_exists' => 'The requested contract does not exists.',
    ...
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Contract.',
    'none_available' => 'No Contracts Available.',
    'model_plural' => 'Contracts',
    'model_was_added' => 'Contract was successfully added.',
    'model_was_retrieved' => 'Contract was successfully retrieved.',
    'models_were_retrieved' => 'Contracts were successfully retrieved.',
    'model_was_updated' => 'Contract was successfully updated.',
    'model_was_deleted' => 'Contract was successfully deleted.',
