...
return [
    ...
    'price_title__placeholder' => 'Enter price title here...',
    ...
    'index_route_description' => 'Retrieve existing prices.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the price property name where the value is the assigned value to the retrieved price.',
    ...
    'show_route_description' => 'Retrieve existing price.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the price to retrieve',
    'destroy_route_description' => 'Delete existing price.',
    ...
    'the_id_of_model_to_delete' => 'The id of the price to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete prices.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the price.',
    ...
    'the_requested_model_does_not_exists' => 'The requested price does not exists.',
    ...
    'edit' => 'Edit Price',
    'show' => 'Show Price',
    'show_all' => 'Show All Price',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Price.',
    'none_available' => 'No Prices Available.',
    'model_plural' => 'Prices',
    'model_was_added' => 'Price was successfully added.',
    'model_was_retrieved' => 'Price was successfully retrieved.',
    'models_were_retrieved' => 'Prices were successfully retrieved.',
    'model_was_updated' => 'Price was successfully updated.',
    'model_was_deleted' => 'Price was successfully deleted.',
