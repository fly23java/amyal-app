...
return [
    ...
    'price_id' => 'Price',
    'price_id__placeholder' => 'Select price',
    ...
    'dispersal_city_id' => 'Dispersal City',
    'dispersal_city_id__placeholder' => 'Select dispersal city',
    'price' => 'Price',
    'price__placeholder' => 'Enter price here...',
    'accepted_user_id' => 'Accepted User',
    'accepted_user_id__placeholder' => 'Select accepted user',
    ...
    'index_route_description' => 'Retrieve existing price details.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the price detail property name where the value is the assigned value to the retrieved price detail.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved price detail.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of price details per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved price detail.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new price detail.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existing price detail.',
    ...
    'show_route_description' => 'Retrieve existing price detail.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the price detail to retrieve',
    'destroy_route_description' => 'Delete existing price detail.',
    ...
    'the_id_of_model_to_delete' => 'The id of the price detail to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete price details.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the price detail.',
    ...
    'the_requested_model_does_not_exists' => 'The requested price detail does not exists.',
    ...
    'create' => 'Create New Price Detail',
    'delete' => 'Delete Price Detail',
    'edit' => 'Edit Price Detail',
    'show' => 'Show Price Detail',
    'show_all' => 'Show All Price Detail',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Price Detail.',
    'none_available' => 'No Price Details Available.',
    'model_plural' => 'Price Details',
    'model_was_added' => 'Price Detail was successfully added.',
    'model_was_retrieved' => 'Price Detail was successfully retrieved.',
    'models_were_retrieved' => 'Price Details were successfully retrieved.',
    'model_was_updated' => 'Price Detail was successfully updated.',
    'model_was_deleted' => 'Price Detail was successfully deleted.',
    ...
    'model_id_camel_case' => 'price detailId',
